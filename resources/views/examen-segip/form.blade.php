<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nota_Practica" class="form-control @error('nota_Practica') is-invalid @enderror" value="{{ old('nota_Practica', $examenSegip?->nota_Practica) }}" id="nota_Practica" placeholder="Nota Practica">
