...
<main class="flex-1 bg-gray-100 text-gray-800 p-6">
    ...
    <section class="bg-white py-10 text-center shadow-lg rounded-lg">
        <div class="bg-white p-10 rounded-lg shadow mx-auto max-w-xl">
            <form method="POST" action="{{ route('rols.update', $rol->id) }}" class="space-y-6">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="permisos" name="permisos" class="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ $rol->permisos }}</textarea>
                </div>

                <div class="flex justify-end">
                    <a href="{{ route('rol.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400 mr-2">
                        Cancelar
                    </a>
