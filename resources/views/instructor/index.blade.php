                                        ...
                                        <td >{{ $clase->id_vehiculo }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('instructors.destroy', $instructor->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('instructors.show', $instructor->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('instructors.edit', $instructor->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
