...
class ExamenSegipController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('examen-segip.create', compact('examenSegip', 'usuariosEstudiantes', 'grupos', 'categorias'));
    }
    ...
    public function destroy($id_est, $id_grupo): RedirectResponse
    {
        $ex = ExamenSegip::where('id_est',$id_est)
