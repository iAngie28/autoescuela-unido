...
{
    if ($pago->estado !== 'PIG') {
        return back()->with('error', 'Este pago no corresponde a un grupo.');
    }
    ...
    // Extraer el nombre de la categoría de forma dinámica
    ...
    // Crear un request simulado para reutilizar la lógica
