...
class ExamenSegip extends Model
{
     ...
     */
    protected $table = 'examen_segip';
    protected $fillable = ['id_est', 'id_grupo', 'nro_intento', 'nota_Teorica', 'nota_Practica', 'estado', 'id_categoria' 'id_pago'];
    ...
    {
        return $this->belongsTo(\App\Models\Pago::class, 'id_pago');
    }
}
