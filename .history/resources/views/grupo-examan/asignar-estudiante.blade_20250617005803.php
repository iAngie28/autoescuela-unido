    ...
    @foreach ($estudiantes as $estudiante)
        <tr class="border-b border-gray-200 hover:bg-gray-100">
            ...
            <td class="py-3 px-6 text-center">
                <select form="form-{{ $estudiante->id }}" name="categoria_id"
            ...
            <td class="py-3 px-6 text-center">
                <select form="form-{{ $estudiante->id }}" name="grupo_id"
                    class="w-full px-2 py-1 border border-gray-300 rounded-md" required>
                    <option value="">Seleccionar</option>
            ...
            <!-- Acciones -->
            <td class="py-3 px-6 text-center">
                <form id="form-{{ $estudiante->id }}" action="{{ route('inscribir_grupo') }}" method="POST">
                    @csrf
