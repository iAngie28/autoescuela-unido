<div class="mb-4">
    ...
    <select name="estado" id="estado"
        ...
        <option value="activo" {{ old('estado', $grupoExaman?->estado) == 'activo' ? 'selected' : '' }}>Activo</option>
        <option value="finalizado" {{ old('estado', $grupoExaman?->estado) == 'finalizado' ? 'selected' : '' }}>Finalizado</option>
    </select>
