<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror" value="{{ old('fecha_inicio', $grupoExaman?->fecha_inicio) }}" id="fecha_inicio" placeholder="Fecha Inicio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="fecha_fin" class="form-control @error('fecha_fin') is-invalid @enderror" value="{{ old('fecha_fin', $grupoExaman?->fecha_fin) }}" id="fecha_fin" placeholder="Fecha Fin">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="datetime-local" name="fecha_hora" class="form-control @error('fecha_hora') is-invalid @enderror" value="{{ old('fecha_hora', $grupoExaman?->fecha_hora) }}" id="fecha_hora" placeholder="Fecha Hora">
