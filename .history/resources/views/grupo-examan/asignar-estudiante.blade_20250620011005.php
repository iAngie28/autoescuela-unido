    ...
    <tr class="border-b border-gray-200 hover:bg-gray-100">
        ...
        <td class="py-3 px-6 text-center">
            <form action="{{ route('inscribir_grupo') }}" method="POST">
                ...
                <select name="categoria_id" class="w-full px-2 py-1 border border-gray-300 rounded-md" required>
        ...
        <td class="py-3 px-6 text-center">
                <select name="grupo_id" class="w-full px-2 py-1 border border-gray-300 rounded-md" required>
                    <option value="">Seleccionar</option>
        ...
        <td class="py-3 px-6 text-center">
                <select name="id_pago" class="w-full px-2 py-1 border border-gray-300 rounded-md" required>
                    <option value="">Seleccionar</option>
                    @foreach ($grupoExamenActivos as $grupo)
                        <option value="{{ $grupo->id }}" 
                            {{ $inscripcion && $inscripcion->id_grupo == $grupo->id ? 'selected' : '' }}>
