...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col">
        ...
        <div class="flex flex-1">
            ...
            <!-- Sidebar -->
            <aside class="hidden peer-checked:flex md:flex flex-col left-0 top-0 min-h-screen w-64 bg-gray-800 transition-all duration-300 ease-in-out z-30">
            ...
            <!-- Contenido principal -->
            <div class="flex-1 @yield('page-classes', '') @yield('background-class', 'bg-gray-100')">
                @if (isset($header))
