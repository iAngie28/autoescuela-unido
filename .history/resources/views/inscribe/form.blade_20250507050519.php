<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_Insc" class="form-control @error('fecha_Insc') is-invalid @enderror" value="{{ old('fecha_Insc', $inscribe?->fecha_Insc) }}" id="fecha__insc" placeholder="Fecha Insc">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_categoria" class="form-control @error('id_categoria') is-invalid @enderror" value="{{ old('id_categoria', $inscribe?->id_categoria) }}" id="id_categoria" placeholder="Id Categoria">
