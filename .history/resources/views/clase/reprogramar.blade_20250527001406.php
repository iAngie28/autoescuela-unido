                    ...
                    <table class="min-w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left whitespace-nowrap">Hora Fin</th>
                                <th class="py-3 px-6 text-left whitespace-nowrap">Id Instructor</th>
                                <th class="py-3 px-6 text-left whitespace-nowrap">Estado</th>
