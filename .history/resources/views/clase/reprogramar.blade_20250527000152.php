                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                <th class="py-3 px-10 text-left">ID</th>
                                <th class="py-3 px-10 text-left">Fecha</th>
                                <th class="py-3 px-10 text-left">Hora Inicio</th>
                                <th class="py-3 px-10 text-center">Hora Fin</th>
                                <th class="py-3 px-10 text-center">Id Instructor</th>
                                <th class="py-3 px-10 text-center">Estado</th>
                                <th class="py-3 px-10 text-center">Accion</th>
                            </tr>
                        </thead>
