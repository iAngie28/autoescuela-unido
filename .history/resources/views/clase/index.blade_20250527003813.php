    ...
    <div class="flex flex-1">
        ...
        <main class="flex-1 bg-gray-100 text-gray-800">
            <section class="bg-white-500 text-black py-10 text-center">
                <!-- Padding SOLO fuera del overflow -->
                <div class="max-w-7xl mx-auto px-6">
                    <h1 class="text-3xl font-bold text-left mb-2">Clases</h1>
                    ...
                    <!-- Aquí va la tabla, con overflow-x-auto -->
                                    ...
                                    <td class="py-3 px-3 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <form action="{{ route('clases.destroy', $clase->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-500 hover:scale-110" onclick="event.preventDefault(); confirm('Are you sure to delete?') ? this.closest('form').submit() : false;">🗑 Eliminar</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
