<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha" class="form-control @error('fecha') is-invalid @enderror" value="{{ old('fecha', $clase?->fecha) }}" id="fecha" placeholder="Fecha">
            {!! $errors->first('fecha', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="hora_inicio" class="form-label">{{ __('Hora Inicio') }}</label>
            <input type="text" name="hora_inicio" class="form-control @error('hora_inicio') is-invalid @enderror" value="{{ old('hora_inicio', $clase?->hora_inicio) }}" id="hora_inicio" placeholder="Hora Inicio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="hora_fin" class="form-control @error('hora_fin') is-invalid @enderror" value="{{ old('hora_fin', $clase?->hora_fin) }}" id="hora_fin" placeholder="Hora Fin">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_paquete" class="form-control @error('id_paquete') is-invalid @enderror" value="{{ old('id_paquete', $clase?->id_paquete) }}" id="id_paquete" placeholder="Id Paquete">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_vehiculo" class="form-control @error('id_vehiculo') is-invalid @enderror" value="{{ old('id_vehiculo', $clase?->id_vehiculo) }}" id="id_vehiculo" placeholder="Id Vehiculo">
            {!! $errors->first('id_vehiculo', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="id_inst" class="form-label">{{ __('Id Inst') }}</label>
            <input type="text" name="id_inst" class="form-control @error('id_inst') is-invalid @enderror" value="{{ old('id_inst', $clase?->id_inst) }}" id="id_inst" placeholder="Id Inst">
            {!! $errors->first('id_inst', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
