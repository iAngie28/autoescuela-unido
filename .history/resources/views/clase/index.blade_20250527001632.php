                    ...
                    <table class="min-w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left whitespace-nowrap">Hora Inicio</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Hora Fin</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Estado</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Comentario Instructor</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Reporte</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Id Paquete</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Id Instructor</th>
                                <th class="py-3 px-6 text-center whitespace-nowrap">Accion</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-600 text-sm">
                            @foreach ($clases as $clase)
                            <tr data-estado="{{ strtolower($clase->estado) }}" class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->id }}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->fecha }}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->hora_inicio}}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{  $clase->hora_fin}}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->estado}}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{$clase->comentario_Inst }}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->reporte_estudiante }}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{  $clase->id_paquete }}</td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">{{ $clase->id_inst }}</td>
