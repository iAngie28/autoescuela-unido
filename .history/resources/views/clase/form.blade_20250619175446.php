...
{{-- Fecha --}}
<div class="mb-4">
    <label for="fecha" class="block font-semibold mb-1">
...
{{-- Hora inicio --}}
<div class="mb-4">
    <label for="hora_inicio" class="block font-semibold mb-1">
        <span class="text-red-500">*</span> Hora Inicio
    </label>
...
{{-- Hora fin --}}
<div class="mb-4">
    <label for="hora_fin" class="block font-semibold mb-1">
        <span class="text-red-500">*</span> Hora Fin
    </label>
...
{{-- Estado --}}
<div class="mb-4">
    <label for="estado" class="block font-semibold mb-1">
    ...
    <select name="estado" id="estado"
        ...
        <option value="programada" {{ old('estado', $clase->estado ?? 'programada') == 'programada' ? 'selected' : '' }}>Programada</option>
        <option value="cancelada" {{ old('estado', $clase->estado ?? 'programada') == 'cancelada' ? 'selected' : '' }}>Cancelada</option>
        <option value="inscrita" {{ old('estado', $clase->estado ?? 'programada') == 'inscrita' ? 'selected' : '' }}>Inscrita</option>
    </select>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        horaInicioInput.addEventListener('change', function () {
            ...
            if (horaInicio) {
                ...
                nuevaHora.setHours(hours + 2);
                nuevaHora.setMinutes(minutes);

                const horaFormateada = nuevaHora.toTimeString().slice(0, 5);
                horaFinInput.value = horaFormateada;
            }
        });
    });
</script>
