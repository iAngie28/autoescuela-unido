                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <form action="{{ route('clases.asignar_clase', $clase->id) }}" method="POST" class="flex items-center justify-center gap-2">
                                                ...
                                                <button type="submit" class="bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600 transition duration-300"
                                            ...
                                            <form action="{{ route('clases.destroy', $clase->id) }}" method="POST" class="mt-2">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="bg-red-500 text-white px-4 py-1 rounded hover:bg-red-600 transition duration-300"
