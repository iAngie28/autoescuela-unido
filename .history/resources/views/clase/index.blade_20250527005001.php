                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-4 text-center">Comentario Instructor</th>
                                <th class="py-3 px-4 text-center">Reporte</th>
                                <th class="py-3 px-4 text-center">Id Paquete</th>
                                <th class="py-3 px-4 text-center">Id Instructor</th>
                        ...
                        <tbody class="text-gray-600 text-sm">
                            ...
                            <tr data-estado="{{ strtolower($clase->estado) }}" class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-4 text-center">{{ $clase->id }}</td>
                                <td class="py-3 px-4 text-center">{{ $clase->fecha }}</td>
                                <td class="py-3 px-4 text-center">{{ $clase->hora_inicio}}</td>
                                <td class="py-3 px-4 text-center">{{  $clase->hora_fin}}</td>
                                <td class="py-3 px-4 text-center">{{ $clase->estado}}</td>
                                <td class="py-3 px-4 text-center">{{$clase->comentario_Inst }}</td>
                                <td class="py-3 px-4 text-center">{{ $clase->reporte_estudiante }}</td>
                                <td class="py-3 px-4 text-center">{{  $clase->id_paquete }}</td>
                                <td class="py-3 px-4 text-center">{{ $clase->id_inst }}</td>
