                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-2 text-left">Hora Inicio</th>
                                <th class="py-3 px-2 text-left">Hora Fin</th>
                                <th class="py-3 px-2 text-center">Id Instructor</th>
                                <th class="py-3 px-2 text-center">Estado</th>
                                <th class="py-3 px-2 text-center">Accion</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-600 text-sm">
                            @foreach ($clases as $clase)
                            <tr data-estado="{{ strtolower($clase->estado) }}" class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-2 text-left">{{ $clase->id }}</td>
                                <td class="py-3 px-2 text-left">{{ $clase->fecha }}</td>
                                <td class="py-3 px-2 text-left">{{ $clase->hora_inicio}}</td>
                                <td class="py-3 px-2 text-left">{{  $clase->hora_fin}}</td>
                                <td class="py-3 px-2 text-left">{{ $clase->id_inst }}</td>
                                <td class="py-3 px-2 text-left">{{ $clase->estado}}</td>
