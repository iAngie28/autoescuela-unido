<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_registro" class="form-control @error('fecha_registro') is-invalid @enderror" value="{{ old('fecha_registro', $user?->fecha_registro) }}" id="fecha_registro" placeholder="Fecha Registro">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_rol" class="form-control @error('id_rol') is-invalid @enderror" value="{{ old('id_rol', $user?->id_rol) }}" id="id_rol" placeholder="Id Rol">
