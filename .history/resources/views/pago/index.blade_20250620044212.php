                                            ...
                                            <div class="flex items-end justify-end space-x-4">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <a href="{{ route('pagos.show', $pago->id) }}"
                                                        class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 transition">👁 <br> Detalles</a>
                                                </div>
