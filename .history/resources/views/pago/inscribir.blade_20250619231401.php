                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            @forelse ($grupos as $grupo)
                                <label class="flex items-center space-x-2 px-3 py-2 border rounded cursor-pointer transition peer-checked:bg-blue-100 peer-checked:border-blue-500 peer-checked:text-blue-700">
