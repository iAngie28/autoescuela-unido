                                            ...
                                            <div class="flex items-end justify-end space-x-4">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <a href="{{ route('pagos.show', $pago->id) }}"
                                                        class="text-blue-500 hover:scale-110 text-sm">Detalles</a>
                                                </div>
                                                <div class="flex flex-col items-center">
                                                    <span>✏</span>
                                                    <a href="{{ route('pagos.edit', $pago->id) }}"
                                                        class="text-green-500 hover:scale-110 text-sm">Inscribir</a>
                                                </div>
                                                <div class="flex flex-col items-center">
                                                    <span>↩️</span>
                                                    <a href="{{ route('pagos.edit', $pago->id) }}"
                                                        class="text-red-500 hover:scale-110 text-sm">Anular</a>
                                                </div>
                                            </div>
                                        </td>
