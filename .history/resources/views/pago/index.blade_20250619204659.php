<div style="z-index:9999; position:relative; background:#fff; padding:20px;">
    <p>Prueba directa:</p>
    <label><input type="radio" name="prueba" value="1"> Opción 1</label>
    <label><input type="radio" name="prueba" value="2"> Opción 2</label>
</div>
