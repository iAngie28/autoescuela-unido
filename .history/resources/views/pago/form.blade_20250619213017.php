<div class="row p-1">
    <div class="col-md-12">
        ...
        <!-- Monto -->
        <!-- Monto (visible pero no editable) -->
        <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function toggleSelects() {
            ...
            if (radioPaquete.checked) {
                document.querySelector('label[for="pago_paquete"]').classList.add('bg-gray-200', 'border-gray-400', 'text-gray-900');
            }
            if (radioGrupo.checked) {
                document.querySelector('label[for="pago_grupo"]').classList.add('bg-gray-200', 'border-gray-400', 'text-gray-900');
            }
        }
