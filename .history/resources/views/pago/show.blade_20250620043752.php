...
@section('content')
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-gray-700  dark:bg-gray-700 shadow-md rounded-lg overflow-hidden">
            <div
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Administrador que registro el pago</h3>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">
