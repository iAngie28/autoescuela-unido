                ...
                @elseif ($pago->estado === 'PIG')
                    ...
                    <div class="space-y-2">
                        @foreach ($grupos as $grupo)
                            <label
                                class="peer-checked:bg-[#1E293B] peer-checked:text-white peer-checked:border-[#1E293B] transition border border-gray-300 rounded px-4 py-2 cursor-pointer flex items-center space-x-2">
                ...
                function actualizarEstilos() {
                    checkboxes.forEach(cb => {
                        ...
                        if (cb.checked) {
                            ...
                            label.classList.add('bg-blue-400', 'border-gray-400', 'text-gray-900');
                        } else {
                            label.classList.remove('bg-blue-400', 'border-gray-400', 'text-gray-900');
