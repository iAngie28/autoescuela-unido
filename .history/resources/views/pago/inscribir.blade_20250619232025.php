...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    ...
    <label class="border rounded px-4 py-2 cursor-pointer flex items-center space-x-2 transition peer-checked:bg-[#1f2937] peer-checked:text-white peer-checked:border-gray-700">
        <input type="checkbox" name="clases[]" value="{{ $clase->id }}" class="hidden peer clase-checkbox">
            ...
            @elseif ($pago->estado === 'PIG')
                ...
                <div class="space-y-2">
                    @foreach ($grupos as $grupo)
                        <label class="peer-checked:bg-gray-800 peer-checked:text-white peer-checked:border-gray-700 transition border rounded px-4 py-2 cursor-pointer flex items-center space-x-2">
