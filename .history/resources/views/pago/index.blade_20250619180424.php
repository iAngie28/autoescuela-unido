                            ...
                            <tbody class="text-gray-600 text-sm">
                                @foreach ($pagos as $i => $pago)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        <td class="py-3 px-6 text-left">{{ $i + $pagos->firstItem() }}</td>
                                        <td class="py-3 px-6 text-left">{{ $pago->monto }}</td>
                                        <td class="py-3 px-6 text-left">{{ $pago->fecha }}</td>
                                        <td class="py-3 px-6 text-left">{{ $pago->descuento }}</td>
                                        <td class="py-3 px-6 text-left">{{ $pago->id_est }}</td>
                                        <td class="py-3 px-6 text-left">{{ $pago->id_adm }}</td>
