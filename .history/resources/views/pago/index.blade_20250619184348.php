...
@section('content')
    ...
    <div class="flex flex-col items-end space-y-2">
        <a href="{{ route('pagos.show', $pago->id) }}"
            class="text-blue-500 hover:scale-110 text-right">👁 <br> Detalles</a>
        <a href="{{ route('pagos.edit', $pago->id) }}"
            class="text-green-500 hover:scale-110 text-right">✏ <br> Inscribir</a>
        <a href="{{ route('pagos.edit', $pago->id) }}"
            class="text-red-500 hover:scale-110 text-right">↩️ <br> Anular</a>
    </div>
</td>
