...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        <div class="bg-gray-800 dark:bg-gray-900 px-4 py-5 border-b border-gray-700 sm:px-6 flex justify-between items-center">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Estudiante ID</h3>
                    <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $pago->id_est }}</p>
                </div>
                <div>
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Administrador ID</h3>
                    <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $pago->id_adm }}</p>
                </div>
            </div>
