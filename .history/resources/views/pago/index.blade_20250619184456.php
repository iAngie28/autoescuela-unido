...
@section('content')
    ...
    <div class="flex items-center justify-end space-x-4">
        <a href="{{ route('pagos.show', $pago->id) }}"
            class="text-blue-500 hover:scale-110 text-sm">👁 <br> Detalles</a>
        <a href="{{ route('pagos.edit', $pago->id) }}"
            class="text-green-500 hover:scale-110 text-sm">✏ <br> Inscribir</a>
        <a href="{{ route('pagos.edit', $pago->id) }}"
            class="text-red-500 hover:scale-110 text-sm">↩️ <br> Anular</a>
    </div>
</td>
