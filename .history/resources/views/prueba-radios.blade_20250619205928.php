...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js']) <!-- tu Tailwind -->
    <style>
        * {
        ...
        <div class="mb-3">
            ...
            <div class="flex items-center gap-6">
                <div class="inline-flex items-center space-x-2">
                    <input type="radio" name="tipo_pago" id="pago_paquete" value="paquete" class="form-radio text-indigo-600">
                    <label for="pago_paquete" class="cursor-pointer">Paquete</label>
                </div>
                <div class="inline-flex items-center space-x-2">
                    <input type="radio" name="tipo_pago" id="pago_grupo" value="grupo" class="form-radio text-indigo-600">
